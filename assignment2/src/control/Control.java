...
//Control interface (used internally by Robot)
...
public interface Control
{
	...
	public static final int MIN_BAR_HEIGHT = 0;
	...
	public static final int MAX_STACK_HEIGHT = 12;
	public static final int MAX_TOTAL_BLOCK_HEIGHT = MAX_STACK_HEIGHT * 2;
	public static final int MAX_BLOCKS = MAX_TOTAL_BLOCK_HEIGHT / MIN_BLOCK_HEIGHT;
	
	public static final int ARM_COLUMN = 0;
	public static final int STACK1_COLUMN = 1;
	public static final int STACK2_COLUMN = MAX_WIDTH;
